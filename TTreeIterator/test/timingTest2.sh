...
c -DUSE_any=1 -DUSE_map=1                      ; t 'map'              'timingTests2.GetIter'
c -DUSE_any=1 -DUSE_OrderedMap                 ; t 'map+vector'       'timingTests2.GetIter'
c -DUSE_any=1                                  ; t 'vector'           'timingTests2.GetIter'
